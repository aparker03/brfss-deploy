...
def load_data():
    ...
    url = "https://www.dropbox.com/scl/fi/7uu8km9qqinzpn3lcfl88/brfss_2022.csv?rlkey=er6mrhhizmhk6i9sn2coobo1h&st=u4gu6drn&dl=1"
    df = pd.read_csv(url)

    # Standardize column names
    df.columns = df.columns.str.upper().str.strip()

    # Basic filtering for valid categories
